...
/**
 * Reject a URL that could be parsed as a yt-dlp/ffmpeg option. A literal '--'
 * is also placed before the URL positional at every call site, but guarding
 * here rejects hostile input as early as possible.
 */
